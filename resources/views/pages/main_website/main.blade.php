        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="https://github.com/vix-4800/WealthGuardian" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="{{asset('img/logo.png')}}" alt="hero image" class="rounded-xl aspect-auto w-80 h-80">
            </div>
        </div>
    </section>
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                        Effortlessly integrate with your existing tools.
                    </h2>
                    <p class="mb-8 font-light lg:text-xl">
                        Deliver efficient service experiences swiftly, without the complexities of traditional solutions.
                    </p>
                    <p class="mb-8 font-light lg:text-xl">
        ...
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            <div class="col-span-2 mb-8">
                ...
                <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
                    ...
                    of all we do. We work tirelessly to protect you and your customers.
                </p>
                ...
                <figcaption class="flex items-center justify-center mt-6 space-x-3">
                    ...
                    <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                        ...
                        <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">
                            Founder at FinTech Innovations
                        </div>
                    </div>
                </figcaption>
            </figure>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow hover:shadow-2xl dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                    ...
                    <a href="{{route('subscription.index')}}" class="text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-purple-900">
                        Get started
                    </a>
                </div>
                @endforeach
            ...
            <div class="max-w-screen-md mx-auto">
                <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
                    ...
                    <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            <p class="mb-2 text-gray-500 dark:text-gray-400">
                                Our dedicated support team is ready to assist you. Simply reach out through our
                                contact form or utilize the in-app support feature, and we'll promptly address any questions or concerns you may have.
                            </p>
                        </div>
                    </div>
