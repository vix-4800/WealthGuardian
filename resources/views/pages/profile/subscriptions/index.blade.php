                            ...
                            <div>
                                ...
                                <div x-show='showAll' x-cloak>
                                    <div class="flex gap-3">
                                        ...
                                        <div class="flex flex-col justify-between max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                                            <h5 class="flex justify-between mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                                                {{$subscription->name}}
                                                <span class="{{$subscription->id === $currentSubscription->id ? 'border border-green-400 bg-green-100 text-green-800' : 'border border-red-400 bg-red-100 text-red-800'}} h-fit  text-xs font-medium me-2 px-2.5 py-0.5 rounded ">
                                                    {{$subscription->id === $currentSubscription->id ? 'Active' : 'Inactive'}}
                                                </span>
                                            </h5>
                                            <p class="font-normal text-gray-700 dark:text-gray-400">
