                    ...
                    <form class="mx-8" method="POST" action="{{route('accounts.store')}}">
                        ...
                        <div class="mb-5">
                            ...
                            <select name="type" id="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <option value="{{\App\Models\Account::TYPE_CARD}}">
                                    {{ucfirst(\App\Models\Account::TYPE_CARD)}}
                                </option>
                                <option value="{{\App\Models\Account::TYPE_CASH}}">
                                    {{ucfirst(\App\Models\Account::TYPE_CASH)}}
                                </option>
                                <option value="{{\App\Models\Account::TYPE_E_WALLET}}">
                                    {{ucfirst(\App\Models\Account::TYPE_E_WALLET)}}
                                </option>
                                <option value="{{\App\Models\Account::TYPE_DEPOSIT}}">
                                    {{ucfirst(\App\Models\Account::TYPE_DEPOSIT)}}
                                </option>
                            </select>
                        </div>
