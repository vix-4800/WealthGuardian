        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('main') }}">
                        <img src="{{asset('img/logo.png')}}" class="w-10 h-10 rounded-lg" alt="Wealth Guardian Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link href="{{ route('accounts.show') }}" :active="Str::startsWith(Route::currentRouteName(), 'accounts')">
                        {{ __('Accounts') }}
                    </x-nav-link>
                </div>
